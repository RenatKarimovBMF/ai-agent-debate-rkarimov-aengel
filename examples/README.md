...
| File | What it is |
|------|------------|
| [`transcript_57cf02c2.md`](transcript_57cf02c2.md) | The full turn-by-turn transcript (all 20 turns + verdict) |
| [`verdict_57cf02c2.json`](verdict_57cf02c2.json) | The machine-readable verdict the judge produced |
...
[`verdict_57cf02c2.json`](verdict_57cf02c2.json).
